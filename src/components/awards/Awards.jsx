...
const Awards = () => {
    ...
    return (
        <div className="my-16">
            <div className="container relative max-w-full p-4 flex lg:flex-row flex-col md:gap-0 gap-6 mx-auto">
                <div className="rounded-lg lg:max-w-30 xl:max-w-2/3 w-fit mx-auto lg:min-w-30 h-fit relative overflow-hidden ">
                ...
                <div className="sm:px-28 px-8 pb-16 pt-6 lg:pt-0 z-30 shadow-xl rounded-lg lg:w-auto w-full h-fit lg:-left-20 bg-white lg:top-16 md:-top-10 top-0 mx-auto md:mx-0 xxs:max-w-40r lg:max-w-1/2 relative lg:right-0">
                    <div className="lg:-rotate-90 absolute lg:-left-0 lg:top-24 sm:left-28 left-8 top-0 text-xl flex items-center gap-3">
                    ...
                    <p style={animatedCard} className='text-61 leading-9 xs:text-lg text-sm mb-8 w-full transition-all duration-500' >{awards.text}</p>
                    <div className="flex justify-between ">
                        ...
                        <div className="arrows flex gap-3">
                            <div onClick={() => awardClick(-1)} className='px-3 py-2 rounded-lg text-bbb hover:bg-black hover:text-white transition-all duration-200 cursor-pointer h-fit bg-eee' >
