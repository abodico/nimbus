...
const Counters = ({scrolledToCounter}) => {
    return (
        <div className='w-full xs:px-4'>
            <div id='counters' className='portfolio__home-counter container mx-auto w-full background-dark relative mt-24 rounded-lg overflow-hidden mb-16'  >
                        ...
                        counterData.map((item, index) => {
                            return (
                                <li key={index} className='block flex-1'>
                                    ...
                                    <span className='text-base xs:text-lg  block mt-6 back-color'>{item.text}</span>
                                </li>
                            )
                        })
                    }
