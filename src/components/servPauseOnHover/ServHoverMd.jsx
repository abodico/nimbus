...
render() {
    ...
    return (
        <div className="portfolio__services-hover mx-auto md:block lg:hidden hidden container bg-white max-w-full px-4">
            <Slider {...settings} >
                {servPauseOnHover.map((item, index) => {
                    return (
                        <div className="card my-16 w-11/12 hover:-translate-y-6 relative transition-all duration-300" key={index}>
