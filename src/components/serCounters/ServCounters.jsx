...
const ServCounters = () => {
    ...
    setTimeout(() => {
        const counter = document.getElementById("serv-counter").offsetTop;
        onscroll = () => {
            if (window.scrollY >= counter - 300) {
                setScrolledToCounter(true);
            }
        }
    }, 20);
    return (
        <div id='serv-counter' className='portfolio__serCounters flex justify-between bg-none'>
