...
const About = () => {
    ...
    setTimeout(() => {
        const counts = document.getElementById('about-me-counts').offsetTop; 
        onscroll = ()=>{
    ...
    return (
        <div id='about-me-counts' className="bg-section overflow-hidden">
            <div className='portfolio__about py-40 relative flex lg:flex-row max-w-full px-4 flex-col items-center container mx-auto lg:px-12' >
                ...
                <div className="portfolio__about-content lg:max-w-40 relative">
                    ...
                    <p className="back-color mt-6 leading-8 xs:text-lg text-base">Since 2015 I have been a visionary and a reliable software engineering partner for world-class brands. These are the words we live by in everything we do. Every story we tell, every brand we build, and every interaction we create must not only look beautiful.</p>
