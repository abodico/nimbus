  ...
  return (
    <div className='relative' >
      ...
      <div className="relative overflow-hidden ">
        ...
        <div className="relative md:mt-28 xs:mt-16 xxs:mt-64  gap-5 lg:px-8 xs:px-4 xxs:px-2 max-w-full z-10 flex flex-col container mx-auto ">
        ...
        {/* about-me */}
        <div  className='container mx-auto relative flex lg:flex-row flex-col items-center justify-between ' >
        ...
        {/* my-skills */}
        <div ref={skillsRef} className=' container mt-16 mx-auto flex lg:flex-row flex-col lg:gap-0 gap-8 xxs:px-0 xs:px-10' >
        ...
        <div className=" mx-auto max-w-full my-20 ">
          <div className=" flex lg:flex-row max-w-full flex-col container mx-auto xxs:p-2 md:p-6 sm:p-12 lg:p-0">
        ...
        {/* blog */}
        <div className="my-16">
          <div className="w-full xxs:max-w-full container md:px-16 px-8 mx-auto relative flex justify-between sm:flex-row flex-col ">
          ...
          <div className="container mx-auto flex-wrap md:justify-evenly lg:flex-nowrap flex gap-16 lg:px-16 px-8 max-w-full ">
            <BlogLg blogData={blogData} classes='md:max-w-40 lg:max-w-1/3'/>
          </div>
        </div>
        {/* footer */}
        <div className='container mx-auto mt-8 lg:p-16 xs:p-4 max-w-full rounded-lg overflow-hidden' >
          <Footer />
        </div>
      </div>
    </div>
